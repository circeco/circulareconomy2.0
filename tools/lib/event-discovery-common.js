...
const CITY_AREA_LEXICON = {
  ...
  stockholm: {
    names: ['stockholm'],
    areas: [
      'sodermalm', 'vasastan', 'vasastaden', 'ostermalm', 'kungsholmen', 'bromma',
      'vartahamnen', 'soder', 'kista', 'enskede', 'svedmyra', 'stureby',
      'stora essingen', 'lilla essingen', 'essingen', 'odenplan',
      'botkyrka', 'tumba', 'hagelby', 'vallentuna', 'soderhall', 'taby',
      'arninge', 'norrtalje', 'hagersten', 'telefonplan', 'midsommargarden',
      'trettondagsvagen', 'karlaplan', 'mariatorget', 'hotorget',
      'varberg', 'skarholmen',
    ],
  },
